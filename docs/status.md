...
| 版本 | 狀態 | 說明 |
|------|------|------|
| V1 | 進行中 | 1613 pass，0 fail，核心功能完整 + S15b 驗證完成（Hook 鏈路 + 知識域鏈路 + 5 個 E2E workflow 補強） |
| V2 | 規劃中 | 延後 |
...
- **[0.28.1] 2026-03-02**：S15b 驗證 — 迭代 1: Hook 鏈路 + Auto 路由驗證（+23 tests）、迭代 2: 知識域三層鏈路 + 5 個 E2E workflow 補強（+210 tests）→ 1613 pass / 75 files
