# State of Nova — Harness 盤點

**狀態**：applied (xd-vhw3 使用者簽核 2026-04-18)
...
| L3 推理 | ✅ 5 頂層 + kfc family (7 spec-agents) + model-cascade | — | ⚠️ reviewer 部分 |
...
| L3 | agents | 5+kfc | `~/.claude/agents/`：5 頂層（planner / executor / reviewer / hook-executor / skill-executor）+ kfc/ family（7 spec-agents）+ README（非 agent）|
...
- CLAUDE.md §Nova Blueprint（canonical）：`~/.claude/CLAUDE.md`（L49 起）
- ADR-001 Vault Upgrade：`~/.claude/obsidian/semantic/architecture-decisions/ADR-001-vault-upgrade.md`
- ADR-002 Wiki/Skill Refactor：`~/.claude/obsidian/semantic/architecture-decisions/ADR-002-wiki-skill-refactor.md`
- ADR-003 Four Capabilities Closed Loop：`~/.claude/obsidian/semantic/architecture-decisions/ADR-003-four-capabilities-closed-loop.md`
- ADR-004 Obs Rebuild Operation：`~/.claude/obsidian/semantic/architecture-decisions/ADR-004-obs-rebuild-operation.md`
- ADR-005 L1-L4 Harness Unification：`~/.claude/obsidian/semantic/architecture-decisions/ADR-005-l1-l4-harness-unification.md`
- ADR-006 Feedback Loop Completeness：`~/.claude/obsidian/semantic/architecture-decisions/ADR-006-feedback-loop-completeness.md`
- Round 3 討論記錄：`~/projects/nova-brain/spec/討論/master-blueprint-nb-round3.md`
