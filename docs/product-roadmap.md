...
| # | 任務 | 說明 | 狀態 |
|---|------|------|:----:|
| 0-1 | single workflow 跑 10 次 | 真實開發任務，記錄成功率和人工介入次數 | 🔵 2/10 |
| 0-2 | quick workflow 跑 10 次 | 真實開發任務，記錄成功率和人工介入次數 | 🔵 3/10 |
| 0-3 | standard workflow 跑 10 次 | 真實開發任務，記錄成功率和人工介入次數 | 🔵 4/10 |
