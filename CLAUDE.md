...
├── skills/         # 21 個 Skill（WHAT — 知識域 + orchestrator + utilities-with-refs）
│   # 13 knowledge domains: testing, workflow-core, security-kb, database, dead-code, commit-convention, code-review, wording, debugging, architecture, build-system, os-control, autonomous-control
