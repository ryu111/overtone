...
├── skills/         # 22 個 Skill（WHAT — 知識域 + orchestrator + utilities-with-refs）
│   # 14 knowledge domains: testing, workflow-core, security-kb, database, dead-code, commit-convention, code-review, wording, debugging, architecture, build-system, os-control, autonomous-control, craft
...
# 驗證所有元件設定（17 agents + 11 hooks + 22 skills + 27 commands）— agents/skills/hooks/commands 結構校驗
