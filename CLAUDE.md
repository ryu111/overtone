...
├── skills/         # 20 個 Skill（WHAT — 知識域 + orchestrator + utilities-with-refs）
│   # 12 knowledge domains: testing, workflow-core, security-kb, database, dead-code, commit-convention, code-review, wording, debugging, architecture, build-system, os-control
...
# 驗證所有元件設定（17 agents + 11 hooks + 19 skills + 27 commands）
