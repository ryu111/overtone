...
| 迭代語意 | 迭代語意（迭代的前提條件） |
| 常駐服務 | 常駐服務管理（核心行為規則、Server 同步阻塞禁令） |
...
| 瀏覽器工具選擇 | 瀏覽器工具選擇 |
| AskUserQuestion全鏈路 | AskUserQuestion 全鏈路（鏈路說明、防護規則、踩坑記錄（2026-04-01）） |
...
| 任務 | 類型 | 優先 | 深度 | 認領時間 | 狀態 |
|------|------|:----:|:----:|---------|------|
| 修復自驅引擎重複結案-bug | 功能 | P2 | D1 | 2026-04-01 | 進行中 |
| 建立卡住自動通知-Manager-機制 | 功能 | P2 | D1 | 2026-04-01 | 進行中 |
...
| D2-delivery-機制根因重構 | 功能 | 2026-04-01 | — |
| transcript-ring-buffer | 功能 | 2026-04-01 | — |
| 建立-tmux-dashboard-腳本 | 功能 | 2026-03-31 | — |
