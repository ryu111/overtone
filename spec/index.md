...
| 深度路由 | 深度路由（Skill 先查原則、Session 內任務追蹤、Planner 職責） |
...
| 總結格式 | 總結格式 + Spec 任務追蹤（格式、規則、任務生命週期、index.md 同步） |
...
| 任務 | 類型 | 優先 | 深度 | 建立時間 |
|------|------|:----:|:----:|---------|
| D1-eval-離線-fallback | 功能 | P2 | D1 | 2026-03-22 |
| D1-behaviors-品質審計 | 功能 | P2 | D1 | 2026-03-22 |
| D1-heartbeat-spawn-error-修復 | 功能 | P2 | D1 | 2026-03-22 |
| D0-roadmap-數字更新 | 功能 | P2 | D1 | 2026-03-22 |
| D1-context-injector-瘦身 | 功能 | P2 | D1 | 2026-03-22 |
| D1-rules-數量治理 | 功能 | P2 | D1 | 2026-03-22 |
