...
const KNOWN_WEIGHTS = {
  'tests/unit/session-start-handler.test.js': 11169,
  'tests/unit/session-end-handler.test.js': 9278,
  'tests/integration/session-start.test.js': 6354,
  'tests/integration/health-check.test.js': 3906,
  'tests/integration/platform-alignment-session-end.test.js': 3520,
  'tests/e2e/smoke.test.js': 3009,
  'tests/integration/os-scripts.test.js': 2564,
  'tests/integration/pre-compact.test.js': 2507,
  'tests/unit/health-check.test.js': 1860,
  'tests/unit/guard-system.test.js': 1935,
  'tests/unit/health-check-internalization.test.js': 1431,
  'tests/unit/health-check-os-tools.test.js': 1384,
  'tests/unit/health-check-proactive.test.js': 1364,
  'tests/e2e/guard-system-e2e.test.js': 1361,
  'tests/integration/feedback-loop.test.js': 1337,
  'tests/integration/agent-on-stop.test.js': 1336,
  'tests/e2e/full-workflow.test.js': 1226,
  'tests/integration/gh-check.test.js': 1134,
  'tests/unit/dead-code-scanner.test.js': 1110,
  'tests/e2e/secure-workflow.test.js': 1102,
  'tests/e2e/workflow-lifecycle.test.js': 1044,
  'tests/e2e/standard-workflow.test.js': 1032,
  'tests/unit/websocket.test.js': 1010,
};
