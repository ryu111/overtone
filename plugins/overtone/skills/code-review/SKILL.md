...
| 檔案 | 說明 |
|------|------|
| 💡 `./references/pr-review-checklist.md` | PR Review 多維度檢查清單 |
| 💡 `./references/architecture-review.md` | 架構層面 review patterns（模組耦合、API 一致性、錯誤傳播） |

## 跨域引用

審查測試程式碼時，應同時參考測試反模式指南，識別低品質/重複測試：

💡 測試反模式（6 種）：讀取 `../testing/references/test-anti-patterns.md`
