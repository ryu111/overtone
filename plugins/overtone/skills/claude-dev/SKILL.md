---
name: claude-dev
description: Claude Code Plugin 開發知識。hooks、agents、skills、commands 的 API 格式、settings 設定系統與 Overtone 專有規範。供 developer 和 architect 在開發 plugin 時查詢。
disable-model-invocation: true
user-invocable: false
---

# Claude Dev — plugin 平台知識 + Overtone 規範
