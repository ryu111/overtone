...
💡 Handoff 格式：讀取 `${CLAUDE_PLUGIN_ROOT}/skills/workflow-core/references/handoff-protocol.md`
...
💡 完整規則：讀取 `${CLAUDE_PLUGIN_ROOT}/skills/workflow-core/references/parallel-groups.md`
...
💡 完整流程：讀取 `${CLAUDE_PLUGIN_ROOT}/skills/workflow-core/references/failure-handling.md`
...
💡 各 workflow 信號清單：讀取 `${CLAUDE_PLUGIN_ROOT}/skills/workflow-core/references/completion-signals.md`