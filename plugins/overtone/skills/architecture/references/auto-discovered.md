...
根據 architect 的 design.md 及 PM 驗收標準，為 `instinct-pollution-fix` feature 撰寫完整的 GIVEN/WHEN/THEN 行為規格，涵蓋三個 Feature 共 11 個 Scenario。
Keywords: spec, architect, design, instinct, pollution, feature, given, scenario
