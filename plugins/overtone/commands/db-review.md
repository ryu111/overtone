...
使用 Bash 執行：
```bash
bun ~/.claude/scripts/init-workflow.js db-review ${CLAUDE_SESSION_ID}
```
...
💡 三維度完整清單：讀取 `~/.claude/skills/database/references/database-review-checklist.md`
💡 報告格式範例：讀取 `~/.claude/skills/database/examples/db-review-report.md`
